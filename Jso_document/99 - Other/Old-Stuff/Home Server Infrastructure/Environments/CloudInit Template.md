1. Download the ISO using the GUI (tested on [https://cloud-images.ubuntu.com/lunar/current/lunar-server-cloudimg-amd64-disk-kvm.img](https://cloud-images.ubuntu.com/lunar/current/lunar-server-cloudimg-amd64-disk-kvm.img))
...
-> Full tutorial video: https://www.youtube.com/watch?v=Kv6-_--y5CM&t=947s